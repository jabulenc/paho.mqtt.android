...
open class MqttService : Service(), MqttTraceHandler {
    ...
    override fun onBind(intent: Intent): IBinder? {
        ...
        val activityToken = intent
                .getStringExtra(CALLBACK_ACTIVITY_TOKEN)
    ...
    override fun traceDebug(tag: String, message: String) {
        traceCallback(TRACE_DEBUG, tag, message)
    }
    ...
    override fun traceError(tag: String, message: String) {
        traceCallback(TRACE_ERROR, tag, message)
    }

    private fun traceCallback(severity: String, tag: String, message: String) {
        if (traceCallbackId != null && isTraceEnabled) {
            val dataBundle = Bundle()
            dataBundle.putString(CALLBACK_ACTION, TRACE_ACTION)
            dataBundle.putString(CALLBACK_TRACE_SEVERITY, severity)
            dataBundle.putString(CALLBACK_TRACE_TAG, tag)
            //dataBundle.putString(MqttServiceConstants.CALLBACK_TRACE_ID, traceCallbackId);
            dataBundle.putString(CALLBACK_ERROR_MESSAGE, message)
    ...
    override fun traceException(tag: String, message: String, e: Exception) {
        if (traceCallbackId != null) {
            val dataBundle = Bundle()
            dataBundle.putString(CALLBACK_ACTION, TRACE_ACTION)
            dataBundle.putString(CALLBACK_TRACE_SEVERITY, TRACE_EXCEPTION)
            dataBundle.putString(CALLBACK_ERROR_MESSAGE, message)
            dataBundle.putSerializable(CALLBACK_EXCEPTION, e) //TODO: Check
            dataBundle.putString(CALLBACK_TRACE_TAG, tag)
            //dataBundle.putString(MqttServiceConstants.CALLBACK_TRACE_ID, traceCallbackId);
            callbackToActivity(traceCallbackId, Status.ERROR, dataBundle)
        }
    ...
    private fun registerBroadcastReceivers() {
        if (networkConnectionMonitor == null) {
            ...
            registerReceiver(networkConnectionMonitor, IntentFilter(
